        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-no-repeat bg-cover login-container">
            ...
            <div className="w-full mx-auto bg-white rounded-xl z-10 p-5 pt-0 border relative bg-gray-lightest"
                ...
                <div className="relative mb-3">
                    <label className="z-15 absolute mt-1 ml-3 text-xs text-gray">Sunucu</label>
                    <input className="cs-big-input z-10 appearance-none" list="server-options" />
                ...
                <div className="relative mb-3">
                    ...
                    <input className="cs-big-input z-10" />
                </div>

                <div className="relative mb-3">
                    <label className="z-15 absolute mt-1 ml-3 text-xs text-gray">Şifre</label>
                    <input type="password" className="cs-big-input z-10" />
                </div>
                ...
                <div className="flex flex-col items-center">
                    <button className="px-10 py-2 rounded text-center text-sm bg-blue-500 text-white mx-auto mt-5 font-bold"
                        onClick={connect}>
                        Bağlan
                    </button>
