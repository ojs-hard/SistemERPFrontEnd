...
import GeneralBusinessCodeAddBlock from './GeneralBusinessCodeAddBlock';
...
export default function GeneralBusinessCodeModal(props) {
    ...
    return(
        <React.Fragment>
            <Modal isFullScreen={isFullScreen} onClose={props.onClose}>
                ...
                <div className="flex-grow">
                    ...
                    <div className="flex justify-center">
                        ...
                        <button className="btn mx-1 px-6 bg-green-400 text-white" onClick={() => setAddBlockOpened(true)}>Ekle</button>
            ...
            {isAddBlockOpened &&
                <GeneralBusinessCodeAddBlock onClose={() => setAddBlockOpened(false)} />
            }
        </React.Fragment>
    );
}
